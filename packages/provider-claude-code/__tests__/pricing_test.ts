...
describe('pricingForClaudeCodeModelKey', () => {
  test('returns documented base rates for dated Opus and Fable', () => {
    ...
    expect(priceRequest(pricingForClaudeCodeModelKey('claude-opus-5-5'), { inputTokens: 0 }).rates).toEqual(published({ input_tokens: '4', input_cache_read_tokens: '0.2', input_cache_write_tokens: '5', input_cache_write_1h_tokens: '8', output_tokens: '20' }));
    ...
    expect(priceRequest(pricingForClaudeCodeModelKey('claude-fable-5-1'), { inputTokens: 0 }).rates).toEqual(published({ input_tokens: '10', input_cache_read_tokens: '0.25', input_cache_write_tokens: '12.5', input_cache_write_1h_tokens: '20', output_tokens: '50' }));
  ...
  test('returns explicit fast entries for supported Opus models', () => {
    ...
    expect(priceRequest(pricingForClaudeCodeModelKey('claude-opus-5-5'), { serviceTier: 'fast', inputTokens: 0 }).rates).toEqual(published({ input_tokens: '8', input_cache_read_tokens: '0.4', input_cache_write_tokens: '10', input_cache_write_1h_tokens: '16', output_tokens: '40' }));
    ...
    expect(priceRequest(pricingForClaudeCodeModelKey('claude-fable-5-1'), { serviceTier: 'fast', inputTokens: 0 }).rates).toEqual(published({ input_tokens: '10', input_cache_read_tokens: '0.25', input_cache_write_tokens: '12.5', input_cache_write_1h_tokens: '20', output_tokens: '50' }));
  });
